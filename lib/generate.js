...
import { SequenceOrder } from "./types.js";
 ...
 */
export function makeHeaderBysquare(header = [
    0, 0,
    0, 0
]) {
 ...
 */
export function makeChecksum(tabbedInput) {
 ...
 * @see 3.10. Appending CRC32 checksum
 */
export function prepareForCompression(model) {
 ...
 */
export function makeTabbed(model) {
