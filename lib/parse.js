...
import { PaymentOptionsEnum } from "./index.js";
 ...
 */
export function buildModel(tabbed) {
    const fields = tabbed
        .split("\t")
    ...
    for (let i = 0; i < payments; i++) {
        ...
        const [ammount, currencyCode, paymentDueDate, variableSymbol, constantSymbol, specificSymbol, originatorsReferenceInformation, paymentNote] = paymentField;
        const payment = {
            bankAccounts: [],
